          ...
          <div className="flex-1 pr-2">
            ...
            {toast.type === "success" && (
              <div className="flex items-center mb-2">
                <div className="w-6 h-6 bg-[#c82a54] rounded-full flex items-center justify-center mr-2">
                  <svg
            ...
            {/* Transaction Link */}
            {toast.hash && (
              <div className="mt-2 pt-2 border-t border-[#353e34]">
                <ExplorerLink
                  value={toast.hash}
                  type="tx"
                  text="View Transaction"
                  className="text-xs text-[#c82a54] hover:text-[#c82a54]/80 underline"
                />
              </div>
            )}
          </div>
