...
const LaunchAppButtons = ({ domain = "secondorder.fun" }) => {
  ...
  return (
    <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
      ...
      <Button variant="farcaster" asChild className="w-[220px] px-6 py-3 rounded-lg font-semibold">
        <a
          href={farcasterUrl}
          target="_blank"
      ...
      {showBaseApp && (
        <Button variant="base" asChild className="w-[220px] px-6 py-3 rounded-lg font-semibold">
          <a
            href={baseAppUrl}
            target="_blank"
            rel="noopener noreferrer"
