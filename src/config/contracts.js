...
export const CONTRACTS = {
  ...
  MAINNET: {
    ...
    SOF: import.meta.env.VITE_SOF_ADDRESS_MAINNET || "",
    SEASON_FACTORY: import.meta.env.VITE_SEASON_FACTORY_ADDRESS_MAINNET || "",
    SEASON_GATING: import.meta.env.VITE_SEASON_GATING_ADDRESS_MAINNET || "",
    INFOFI_FACTORY: import.meta.env.VITE_INFOFI_FACTORY_ADDRESS_MAINNET || "",
    INFOFI_ORACLE: import.meta.env.VITE_INFOFI_ORACLE_ADDRESS_MAINNET || "",
    INFOFI_SETTLEMENT:
      import.meta.env.VITE_INFOFI_SETTLEMENT_ADDRESS_MAINNET || "",
    INFOFI_MARKET: import.meta.env.VITE_INFOFI_MARKET_ADDRESS_MAINNET || "", // legacy
    INFOFI_FPMM: import.meta.env.VITE_INFOFI_FPMM_ADDRESS_MAINNET || "",
    CONDITIONAL_TOKENS:
      import.meta.env.VITE_CONDITIONAL_TOKENS_ADDRESS_MAINNET || "",
    VRF_COORDINATOR: import.meta.env.VITE_VRF_COORDINATOR_ADDRESS_MAINNET || "",
    PRIZE_DISTRIBUTOR:
