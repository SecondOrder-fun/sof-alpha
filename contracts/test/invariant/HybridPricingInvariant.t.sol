...
contract HybridPricingInvariantTest is StdInvariant, Test {
    ...
    function invariant_probabilitiesInValidRange() public view {
        ...
        assertTrue(raffleProbability >= MIN_PROBABILITY && raffleProbability <= MAX_PROBABILITY, 
            "Raffle probability out of range");
        assertTrue(marketSentiment >= MIN_PROBABILITY && marketSentiment <= MAX_PROBABILITY, 
            "Market sentiment out of range");
        assertTrue(hybridPrice >= MIN_PROBABILITY && hybridPrice <= MAX_PROBABILITY, 
    ...
    function invariant_hybridPriceDeviationBounded() public view {
        ...
        uint256 raffleDeviation = raffleProbability > hybridPrice ? 
            raffleProbability - hybridPrice : hybridPrice - raffleProbability;
            
        // Calculate deviation from market sentiment
        uint256 marketDeviation = marketSentiment > hybridPrice ? 
            marketSentiment - hybridPrice : hybridPrice - marketSentiment;
