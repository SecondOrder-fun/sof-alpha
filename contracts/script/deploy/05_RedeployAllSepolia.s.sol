...
contract RedeployAllSepolia is Script {
    ...
    function run() public {
        ...
        console2.log("VITE_SOF_TOKEN_ADDRESS_TESTNET=", address(sofToken));
        ...
        console2.log("VITE_BONDING_CURVE_ADDRESS_TESTNET=", address(bondingCurve));
        ...
        console2.log("");
        console2.log("--- InfoFi ---");
        console2.log("VITE_CONDITIONAL_TOKEN_ADDRESS_TESTNET=", address(conditionalTokens));
        console2.log("VITE_INFOFI_MARKET_FACTORY_ADDRESS_TESTNET=", address(factory));
